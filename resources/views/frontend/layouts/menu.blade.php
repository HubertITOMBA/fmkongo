                ...
                <div class="col-xl-12">
                    <div class="relative_contect d-flex">
                        ...
                        <ul class="wsus_menu_cat_item show_home toggle_menu">
                            <li><a href="#"><i class="fas fa-star"></i> à la une</a></li>
                            ...
                            <li><a href="#"><i class="fas fa-home-lg-alt"></i> expositions</a></li>
                            <li><a href="#"><i class="far fa-camera"></i> music</a></li>
                            <li><a href="#"><i class="fas fa-heartbeat"></i> nos icônes</a></li>
                            <li><a href="#"><i class="fal fa-gift-card"></i> la gastrononie</a></li>
                            <li><a href="#"><i class="fal fa-gamepad-alt"></i> seminaires</a></li>
                            <li><a href="#"><i class="far fa-camera"></i> tous les évènements</a></li>
                        </ul>

                        <ul class="wsus__menu_item">
                            <li><a class="Active" href="{{url('/')}}">Accueil</a></li>
                            <li><a href="vendor.html">qui sommes-nous ?</a></li>
                            <li><a href="product_grid_view.html">évènements <i class="fas fa-caret-down"></i></a>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3">
                                            <div class="wsus__mega_menu_colum">
                                                ...
                                                <ul class="wsis__mega_menu_item">
                                                    <li><a href="#">Pourquoi FMKongo </a></li>
                                                    <li><a href="#">nos séminaires</a></li>
                                                    <li><a href="#">nos séminaires</a></li>
                                                    <li><a href="#">nos séminaires</a></li>
                                                    <li><a href="#">nos séminaires</a></li>
                                                    {{-- <li><a href="#">nos séminaires</a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-3">
                                            <div class="wsus__mega_menu_colum">
                                                <h4>Concerts</h4>
                                                <ul class="wsis__mega_menu_item">
                                                    <li><a href="#">Festival Musique  Congolaise</a></li>
                                                    <li><a href="#">Road trip Bakolo miziki</a></li>
                                                    <li><a href="#">Christone KingFish à Kinshasa</a></li>
                                                    <li><a href="#">Clothing</a></li>
                                                    <li><a href="#">Jazz à kin</a></li>
                                                    {{-- <li><a href="#">Bags</a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-3">
                                            <div class="wsus__mega_menu_colum">
                                                <h4>culture et art</h4>
                                                <ul class="wsis__mega_menu_item">
                                                    <li><a href="#">Wenze ya bikeko</a></li>
                                                    <li><a href="#">culture et art</a></li>
                                                    <li><a href="#">culture et art</a></li>
                                                    <li><a href="#">culture et art</a></li>
                                                    {{-- <li><a href="#">culture et art</a></li>
                                                    <li><a href="#">Bags</a></li>
                            ...
                            <li><a href="vendor.html">université <i class="fas fa-caret-down"></i></a>
                                <div class="wsus__mega_menu">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3">
                                            <div class="wsus__mega_menu_colum">
                                        ...
                                        <div class="col-xl-3 col-lg-3">
                                            <div class="wsus__mega_menu_colum">
                                                <h4>culinaire et social</h4>
                                                <ul class="wsis__mega_menu_item">
                                                    <li><a href="#">La place de la ...</a></li>
                                                    <li><a href="#">Bo moto na yo</a></li>
                                                    <li><a href="#">la gastronomie kinoise</a></li>
                                                    <li><a href="#">tutti quanti</a></li>
                                                    <li><a href="#">yekola kolamba</a></li>
                                                    <li><a href="#">Voir tous les cours</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-3">
                                        ...
                                        <div class="col-xl-3 col-lg-3">
                                            <div class="wsus__mega_menu_colum">
                                                ...
                                                <ul class="wsis__mega_menu_item">
                                                    ...
                                                    <li><a href="#">developpent web</a></li>
                            ...
                            <li><a href="daily_deals.html">blog</a></li>
                        ...
                        <ul class="wsus__menu_item wsus__menu_item_right">
                            ...
                            <li><a href="dsahboard.html">mon compte</a></li>
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                    role="tab" aria-controls="pills-home" aria-selected="true">évènements</button>
            </li>
            <li class="nav-item" role="presentation">
                ...
                <div class="wsus__mobile_menu_main_menu">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <ul class="wsus_mobile_menu_category">
                            ...
                            <li><a href="#"><i class="far fa-camera"></i> Music</a></li>
                            <li><a href="#"><i class="fas fa-heartbeat"></i> nos icônes</a></li>
                            <li><a href="#"><i class="fal fa-gift-card"></i> la gastronomie</a></li>
                            <li><a href="#"><i class="fal fa-gamepad-alt"></i> séminaires</a></li>
                            <li><a href="#"><i class="fal fa-gem"></i> tous les évènements</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample2">
                        <ul>
                            ...
                            <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapseThree">évènements</a>
                            ...
                            <li><a href="vendor.html">université</a></li>
                            <li><a href="blog.html">partenaires</a></li>
                            <li><a href="daily_deals.html">blog</a></li>
                            {{-- <li><a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
