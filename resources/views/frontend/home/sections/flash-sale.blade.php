                ...
                <div class="col-xl-12">
                    <div class="offer_time" style="background: url(images/flash_sell_bg.jpg)">
                        <div class="wsus__flash_coundown">
                            <span class=" end_text">Féstival de Kinshasa</span>
                            <h6 style="color:bisque;">" Le 2 juillet biso tembe na foire ! "</h6>
                            <div class="simply-countdown simply-countdown-one"></div>
                            <a class="common_btn" href="#">plus d'info <i class="fas fa-caret-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
