                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="wsus__change_password">
                            ...
                            <div class="wsus__single_pass">
                                <label>email</label>
                                <input id="email" type="email" name="email" value="{{old('email', $request->email)}}" placeholder="Mot de passe actuel">
                            </div>
                            <div class="wsus__single_pass">
                            ...
                            <button class="common_btn" type="submit">soumettre</button>
                        </div>
                    </form>
                </div>
            </div>
